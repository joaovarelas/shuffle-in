...
class Discogs:
    ...
    def search(self, query, style, shuffle):
        params = "database/search?type=release&per_page=1&query={}&style={}".format(query, style)
        ...
        if shuffle:
            ...
            params = "database/search?type=release&per_page=1&page={}&query={}&style={}".format(page, query, style)
            resp = self.request(params)
